...
public  class HttpURLConnection {
    ...
    private void sendPost() throws Exception {
        ...
        String queryArgs = "command=buy&currencyPair=BTC_DASH&rate=0.00001000&amount=100.00000000&nonce=" + nonce;
        ...
        params.add(new BasicNameValuePair("currencyPair", "BTC_DASH"));
        params.add(new BasicNameValuePair("rate", "0.00001000"));
        params.add(new BasicNameValuePair("amount", "100.00000000"));
